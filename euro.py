...
Exercise 3.15 (page 50): A statistical statemente appeared in 
"The Guardian" on Friday January 4, 2002:

When spun on edge 250 times, a Belgian one-euro coin came
up heads 140 times and tails 110. 'It looks very suspicious
to me,' said Barry Blight, a statistics lecturer at th London
...
class Euro2(thinkbayes.Suite):
    ...
    def Likelihood(self, data, hypo):
        """Computes the likelihood of the data under the hypothsis.
...
def RunUpdate(suite, heads=140, tails=110):
    """Update the Suite with the given number of heas and tails.
